<x-layouts.app>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div class="flex items-center justify-between mb-6">
            <div>
                <h1 class="text-2xl font-semibold text-neutral-900">Vehicle Listings</h1>
                <p class="text-sm text-neutral-500 mt-1">Manage your dealership's vehicle listings.</p>
            </div>
        ...
        @if ($vehicles->isEmpty())
            <div class="bg-white border border-neutral-200 rounded-xl shadow-sm py-16 text-center">
                <p class="text-neutral-500 text-sm">No vehicle listings yet.</p>
                @can('create', App\Modules\Vehicles\Models\Vehicle::class)
                    <a href="{{ route('vendor.vehicles.create') }}"
                       class="mt-3 inline-block text-sm text-[#3DB8E8] hover:underline">Add your first vehicle</a>
                @endcan
            </div>
        @else
