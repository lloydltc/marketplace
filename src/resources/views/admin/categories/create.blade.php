<x-layouts.app>
    <x-slot:title>New Category</x-slot:title>
    ...
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <nav class="text-sm text-neutral-500 mb-6">
            ...
            <span class="text-neutral-900">New Category</span>
        </nav>

        <h1 class="text-2xl font-semibold text-neutral-900 mb-6">Create Category</h1>
