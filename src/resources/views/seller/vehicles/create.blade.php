    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        @else
            ...
            <p class="text-sm text-neutral-500 mb-6">
                ...
                <a href="{{ route('seller.vehicles.create') }}" class="text-[#3DB8E8] hover:underline">Change type</a>
            </p>
            ...
            <form method="POST" action="{{ route('seller.vehicles.store') }}" class="space-y-5" enctype="multipart/form-data">
                ...
                @include('partials.listing-editor-actions', ['cancelUrl' => route('seller.vehicles.index')])
            </form>
        @endif
    </div>
</x-layouts.app>
