<x-layouts.app>
    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <form method="POST" action="{{ route('seller.vehicles.update', $vehicle) }}" class="space-y-5">
            @csrf
            @method('PUT')

            @include('partials.vehicle-form-fields')

            @include('partials.listing-editor-actions', ['cancelUrl' => route('seller.vehicles.show', $vehicle)])
        </form>
