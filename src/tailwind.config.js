/** Salma Drive — Tailwind config (design system v1.0)
 *  Loaded by Tailwind v4 via the `@config` directive in resources/css/app.css.
 *  Semantic utilities (bg-surface, text-muted, border-base, text-brand, …) read
 *  the CSS variables in resources/css/theme.css so light/dark switch
 *  automatically. darkMode: 'class' — the .dark class is set by the no-FOUC head
 *  script and the theme-toggle component. Prefer semantic utilities over raw hex. */
